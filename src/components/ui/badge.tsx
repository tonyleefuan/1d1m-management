  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-badge font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        secondary:
          'border-transparent bg-[rgba(0,0,0,0.05)] text-foreground hover:bg-[rgba(0,0,0,0.08)]',
        destructive:
          'border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/80',
        outline: 'text-foreground border-[rgba(0,0,0,0.15)]',
        pill: 'border-transparent bg-[#f2f9ff] text-[#097fe8]',
      },
    },
    defaultVariants: {
      variant: 'default',
